...
public class Time {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		System.out.println((end - begin) + " It is " + d);
	}
	...
	public static Date getDateFromNetwork() throws IOException, ParseException {
		 ...
		 * long epoch1970ms = epoch1970.getTime().getTime(); long differenceInMS
		 * = epoch1970ms - epoch1900ms; long differenceBetweenEpochs =
		 * differenceInMS/1000;
		 */
		Socket socket = null;
		try {
...
//				System.out.printf("%x", secondsSince1900);
//				System.out.println();
			}
